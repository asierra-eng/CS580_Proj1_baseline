...
def keys_pressed(d_o_e=tkinter.Tk().tk.dooneevent,
                 d_w=tkinter._tkinter.DONT_WAIT): # d_o_e=None, d_w=None):
    d_o_e(d_w)
    if _got_release:
        d_o_e(d_w)
...
def remove_from_screen(x, d_o_e=tkinter.Tk().tk.dooneevent,
                       d_w=tkinter._tkinter.DONT_WAIT): # # , d_o_e=tkinter.tkinter.dooneevent, d_w=tkinter.tkinter.DONT_WAIT):
    _canvas.delete(x)
    d_o_e(d_w)
...
def move_to(object, x, y=None, d_o_e=tkinter.Tk().tk.dooneevent,
            d_w=tkinter._tkinter.DONT_WAIT): #, d_o_e=tkinter.tkinter.dooneevent, d_w=tkinter.tkinter.DONT_WAIT):
    if y is None:
        try: x, y = x
        except: Exception('incomprehensible coordinates')
...
def move_by(object, x, y=None, d_o_e=tkinter.Tk().tk.dooneevent,
            d_w=tkinter._tkinter.DONT_WAIT, lift=False): #, d_o_e=None, d_w=None, lift=False): #, d_o_e=tkinter.tkinter.dooneevent, d_w=tkinter.tkinter.DONT_WAIT, lift=False):
    if y is None:
        try: x, y = x
